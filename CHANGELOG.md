...
- Simplified the public `decompress()` API and several internal decompression helpers by dropping a `compression_level` parameter that was threaded through many layers but never actually used for anything.
